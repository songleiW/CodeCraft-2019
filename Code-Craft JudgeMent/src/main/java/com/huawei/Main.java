...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		CreateCars.readAnswer(answerPath,allCars);		//创建预制车辆
	...
	public static void calculateScore() {
		...
		System.err.println(Tpri+"   "+Tsumpri);
		System.out.println("最终调度时间:"+NOWTIME+"  "+TE);
		System.out.println("最终总调度时间:"+Tsum+"  "+TESum);
